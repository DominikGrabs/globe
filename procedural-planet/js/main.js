...
var rotationSpeed = -0.006; // planet rotation speed. New One
...
var directionalLight = new THREE.DirectionalLight( 0xff7f50, 1.0 ); //Color CoralRed
directionalLight.position.set( radius*60, radius*0, radius*0 );
...
//Animation
function animate() {
    //waterMesh.rotation.z += 0.011;
    //cloudMesh.rotation.z += 0.011;
    requestAnimationFrame(animate);
    waterMesh.material.uniforms.time.value += -0.11 / 60.0;
    cloudsMesh.material.uniforms.time.value += -0.11 / 60.0;
